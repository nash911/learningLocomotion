...
public:
  ...
  enum ControllerType{Neural_Controller, Naive_Controller, Simple_Controller, Hybrid_Controller, Semi_Hybrid_Controller,
                      ...
                      Fourier_Controller, TriangleSquare_Controller, ExtendedTriangleSquare_Controller};
  ...
  void load_extendedtrianglesquare_control_parameters(void);
  ...
  void set_a0(const double, const unsigned int, const unsigned int);
  void set_a1(const double, const unsigned int, const unsigned int);
  void set_D0(const double, const unsigned int, const unsigned int);
  void set_D1(const double, const unsigned int, const unsigned int);
  void set_sk0(const double, const unsigned int, const unsigned int);
  void set_sk1(const double, const unsigned int, const unsigned int);
  ...
  void set_sp(const double, const unsigned int, const unsigned int);
  ...
  bool validate_amplitude_plus_offset(const double, const double, const unsigned int);

  void recalculate_phase(double&);
...
protected:
  ...
  vector<vector<double> > A; //-- Amplitude
  vector<vector<double> > s; //-- Squareness; 0 <= s < 1
  vector<vector<double> > a; //-- Asymmetry; 0 < a < 1
  vector<vector<double> > D; //-- Duty Cycle; 0 < D <= 1
  vector<vector<double> > sk; //-- Skewness; -1 <= sk <= 1
  vector<double> offset; //-- Offset
  vector<double> phase; //-- Phase
  vector<double> sp; //-- Stabilization Period; 0 < sp
  double frequency; //-- 0 < frequency
