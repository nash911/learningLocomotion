...
void Y1ModularRobot::reset_robot_position(void)
{
...
double Y1ModularRobot::calculate_total_distance_travelled_euclidean(void)
{
    ...
    totalDistanceTravelled = euclidean_distance(robot_pos_initial, robot_pos_final);

    return(totalDistanceTravelled);
}


double Y1ModularRobot::calculate_total_distance_travelled_forward(void)
{
...
double Y1ModularRobot::calculate_distance_travelled_forward(void)
{
    //--Need to be completed
    return 0;
}
...
double Y1ModularRobot::calculate_velocity(void)
{
    //--Need to be completed
    return 0;
}
...
double Y1ModularRobot::calculate_forward_velocity(void)
{
    //--Need to be completed
    return 0;
}
...
double Y1ModularRobot::calculate_velocity_X(void)
{
    //--Need to be completed
    return 0;
}
...
double Y1ModularRobot::calculate_velocity_Y(void)
{
    //--Need to be completed
    return 0;
}
...
double Y1ModularRobot::get_vx(void)
{
    //--Need to be completed
    return 0;
}
...
double Y1ModularRobot::get_robot_Z(void)
{
    return(0);
}
