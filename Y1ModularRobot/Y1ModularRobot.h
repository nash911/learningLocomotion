...
public:
  ...
  double get_robot_feet_X(const std::string feet){return 0;}
  double get_robot_feet_Y(const std::string feet){return 0;}
  double get_robot_feet_Z(const std::string feet){return 0;}
  void record_robot_foot_com(const double time){}
